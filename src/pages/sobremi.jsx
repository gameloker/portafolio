              ...
              <div className="px-6">
                <div className="flex flex-wrap justify-center">
                  ...
                  <div className="w-full lg:w-4/12 px-4   lg:order-3 lg:text-right lg:self-center   ">
                    <div className="py-6 px-3 text-center  lg:mt-0 md:mt-32 sm:mt-32 mt-36  ">
                    <button
        className="bg-pink-500 active:bg-pink-600 uppercase text-white font-bold hover:shadow-md shadow text-xs px-4 py-2 rounded outline-none focus:outline-none  mb-1 ease-linear transition-all duration-150 sm:items-center sm:justify-center "
        type="button"
        ...
        Descargar CV
                  ...
                  <div className="w-full lg:w-4/12 px-4 lg:order-1">
                    ...
                    <div className="lg:mr-4 p-3 text-center">
                        <img src="https://i.imgur.com/xEdJvjk.png" className="w-12 h-12 object-cover" />
                      </div>
                      <div className="lg:mr-4 p-3 text-center">
                        <img src="https://i.imgur.com/4MUgVj2.png" className="w-12 h-12 object-cover" />
                      </div>
                      <div className="lg:mr-4 p-3 text-center">
                        <img src="https://i.imgur.com/xEdJvjk.png" className="w-12 h-12 object-cover" />
                      </div>
